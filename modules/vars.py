...
BOT_TOKEN = environ.get("BOT_TOKEN", "7648787184:AAEhXRSz5OovkbQj9RbreWThXpCHRzzjoa8")

OWNER = int(environ.get("OWNER", "7667306230"))
CREDIT = environ.get("CREDIT", "rana ")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '7667306230').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '7667306230').split(',')
